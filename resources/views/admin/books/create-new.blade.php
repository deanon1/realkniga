...
@section('title', 'Добавить книгу - Админ панель')

@section('content')
<div class="admin-dashboard">
    <div class="admin-header">
        <div class="admin-header-content">
            <h1 class="admin-title">Добавить книгу</h1>
            <p class="admin-subtitle">Создание новой книги в каталоге</p>
        </div>
    ...
    <div class="admin-content">
        <form method="POST" action="/admin/books" class="admin-form" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div style="display: flex; gap: 20px; margin-top: 8px;">
                            <label class="form-label" style="display: flex; align-items: center; cursor: pointer;">
                                <input type="radio" name="category" value="none" class="form-checkbox" checked style="margin-right: 8px;">
                                Обычная книга
                            </label>
                            <label class="form-label" style="display: flex; align-items: center; cursor: pointer;">
                                <input type="radio" name="category" value="new" class="form-checkbox" style="margin-right: 8px;">
                                Новинка
                            </label>
                            <label class="form-label" style="display: flex; align-items: center; cursor: pointer;">
                                <input type="radio" name="category" value="popular" class="form-checkbox" style="margin-right: 8px;">
                                Популярная книга
                            </label>
                        </div>
                    </div>
